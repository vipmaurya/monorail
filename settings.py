...
feedback_email = 'vipin@altorumleren.com'
...
send_all_email_to = 'vipin@altorumleren.com'
...
project_creation_restriction = site_pb2.UserTypeRestriction.ANYONE
...
linkable_domains = {
  ...
  'altorumleren.com': ['altorumleren.com'],
...
domain_to_default_project_dev = {}
domain_to_default_project_staging = {}
...
preferred_domains = {
    'monorail-872021.appspot.com': 'monorail.altorumleren.com',
...
if app_identity.get_application_id() == 'monorail-872021':
  gapi_client_id = (
...
api_allowed_email_domains = ('@altorumleren.com')
